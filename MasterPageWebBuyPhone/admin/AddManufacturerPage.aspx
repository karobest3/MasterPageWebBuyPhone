<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddManufacturerPage.aspx.cs" Inherits="MasterPageWebBuyPhone.admin.AddManufacturerPage1" %>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <asp:CustomValidator SetFocusOnError="true"
                ...
                ControlToValidate="NameMNF"
                Display="Dynamic" ErrorMessage="Name Manufacturer is already exists" ForeColor="Red" OnServerValidate="CheckManufacturer"></asp:CustomValidator>
        </div>
        <asp:Button class="btn btn-primary" ID="btnAddMNF" runat="server" Text="Save"  />
    </div>
</asp:Content>
